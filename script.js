...
discoverButton.addEventListener('click', async () => {
  ...
  try {
      ...
      <div class="bg-gray-800 rounded-xl shadow-lg overflow-hidden">
        <div class="flex flex-col">
          ...
          <div class="movie-image-container">
            <img
              src="${movieDetails.poster_path ? `https://image.tmdb.org/t/p/w500${movieDetails.poster_path}` : 'https://placehold.co/400x600'}"
    ...
    if (trailer) {
      ...
      const movieImageContainer = movieResult.querySelector('.movie-image-container');
